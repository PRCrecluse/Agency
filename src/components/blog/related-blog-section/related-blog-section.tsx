              ...
              <Card className='group h-full overflow-hidden shadow-none'>
                <CardContent className='flex h-full flex-col gap-3.5'>
                  ...
                  <div className='flex items-center justify-between gap-1.5'>
                    ...
                    <Badge className='bg-primary/10 text-primary h-auto rounded-full text-sm'>{post.category}</Badge>
                  </div>
                  ...
                  <div className='flex flex-1 items-end justify-between'>
                    ...
                    <SecondaryFlowButton className='**:data-[slot=button]:size-9 **:data-[slot=button]:px-0'>
